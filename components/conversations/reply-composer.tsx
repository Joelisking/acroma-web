...
function ActiveComposer({
  ...
  return (
    <form
      ...
      className="bg-background sticky bottom-0 px-3 pt-3 pb-[calc(env(safe-area-inset-bottom)+5.5rem)] sm:px-4 sm:pt-4 md:pb-[calc(env(safe-area-inset-bottom)+0.75rem)]"
    >
